...
LinkedDevice::LinkedDevice(View *view) {
  this->view = view;
  connect(this, &LinkedDevice::onCommandResponseReceived, view, &View::onCommandReceived);
}
...
QList<QMap<QString, QVariant>> LinkedDevice::getParsedResponse(const QString &response) {
